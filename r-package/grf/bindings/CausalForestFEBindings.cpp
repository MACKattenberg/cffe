...
// [[Rcpp::export]]
Rcpp::List causal_fe_train(const Rcpp::NumericMatrix& train_matrix,
                        size_t outcome_index,
                        size_t treatment_index,
						size_t individual_fe_index,
						size_t time_fe_index,
						size_t event_time_fe_index,
                        ...
                        unsigned int seed) {
  ForestTrainer trainer = fe_trainer(reduced_form_weight, stabilize_splits);
  ...
  data.set_individual_fe_index(individual_fe_index);
  data.set_time_fe_index(time_fe_index);
  data.set_event_time_fe_index(event_time_fe_index);
  ...
  if (compute_oob_predictions) {
    ForestPredictor predictor = fe_predictor(num_threads);
...
// [[Rcpp::export]]
Rcpp::List causal_fe_predict(const Rcpp::List& forest_object,
  ...
  train_data.set_individual_fe_index(individual_fe_index);
  train_data.set_time_fe_index(time_fe_index);
  train_data.set_event_time_fe_index(event_time_fe_index);
...
// [[Rcpp::export]]
Rcpp::List causal_fe_predict_oob(const Rcpp::List& forest_object,
                              const Rcpp::NumericMatrix& train_matrix,
                              size_t outcome_index,
                              size_t treatment_index,
                              size_t individual_fe_index,
